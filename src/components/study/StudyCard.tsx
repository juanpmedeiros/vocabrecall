...
export function StudyCard({ words, category, onClose }: StudyCardProps) {
  ...
  return (
    <div className="flex flex-col">
      ...
      {/* Flip card container */}
      <div className="min-h-[300px]" style={{ perspective: '1000px' }}>
        <div
        ...
        >
          ...
          >
            ...
            <div className="p-7 flex flex-col items-center justify-center min-h-[280px]">
              ...
              <h3 className="text-3xl font-bold text-gray-900 mb-2 text-center tracking-tight">{currentWord.word}</h3>
          ...
          >
            ...
            <div className="p-7 flex flex-col min-h-[280px]">
              ...
              <p className="text-2xl font-bold text-gray-900 mb-3 text-center flex-1 flex items-center justify-center">{currentWord.translation}</p>
              {currentWord.context && (
              ...
              <div className="flex gap-3 mt-auto">
                <button
                  type="button"
                  onClick={markAsKnown}
                  className="flex-1 py-3 px-4 text-sm font-semibold rounded-xl bg-[var(--success)] text-white hover:opacity-90 transition-opacity"
                >
                  ✓ Já sei
                </button>
                <button
                  ...
                  className="flex-1 py-3 px-4 text-sm font-semibold rounded-xl bg-amber-500 text-white hover:bg-amber-600 transition-colors"
                >
                  ↺ Revisar
                </button>
              </div>
      ...
      <div className="flex items-center justify-center gap-4 mt-6">
        <button
          ...
          className="flex items-center gap-2 px-4 py-2 border border-border rounded-lg text-gray-700 hover:bg-muted disabled:opacity-40 disabled:cursor-not-allowed transition-all"
        >
          <ChevronLeft size={18} />
          Anterior
        </button>
        <button
          type="button"
          onClick={nextCard}
          className="flex items-center gap-2 px-4 py-2 border border-border rounded-lg text-gray-700 hover:bg-muted transition-all"
        >
          Próximo
